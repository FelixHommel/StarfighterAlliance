...
public:
    ...
    GameObject(const WindowInfo* windowInfo)
        : m_windowInfo(windowInfo), m_position(), m_size(), m_rotation(0), m_velocity(), m_lives(0)
    {}
    GameObject(const Texture2D& texture, const WindowInfo* windowInfo)
        : m_windowInfo(windowInfo), m_texture(texture), m_position(), m_size(), m_rotation(0), m_velocity(), m_lives(0)
    {}
