...
Button::Button(const glm::vec2& pos, const glm::vec2& size, const glm::vec3& defaultColor, const glm::vec3& hoveredColor,
	const glm::vec3& pressedColor, const std::string& label, const Shader& shader, float pressCooldownMax)
	: m_shader(shader)
	, m_vao(0)
	, m_position(pos)
	, m_size(size)
